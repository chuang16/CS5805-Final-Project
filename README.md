...
Data results in the 'results.csv' file and graphs can be found in 'runs/detect/train', and test images with bounding boxes applied can be found in 'runs/detect/train3'.
